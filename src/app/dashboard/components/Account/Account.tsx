    ...
    <div className={style.content_block}>
      ...
      <div className={style.block_content}>
        <form onSubmit={ResetAccount} className={style.form_content}>
          <input disabled className={Dirty.Name ? style.form_name_error : ''} type="text" placeholder={User.name} value={User.name} onChange={(e) => setFormValues({ ...formValues, Name: e.target.value })} />
          <input disabled className={Dirty.Email ? style.form_email_error : ''} type="email" placeholder='Введите ваш e-mal*' value={User.email} onChange={(e) => setFormValues({ ...formValues, Email: e.target.value })} />
