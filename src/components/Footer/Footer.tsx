        ...
        <div className={style.footer_menu}>
          ...
          <div className={style.menu_column}>
            ...
            <div className={style.menu_link}>
              <Image src={'/img/telegram.png'} width={40} height={40} alt='telegram'/>
              <Link href='/#'>Telergram</Link>
            </div>
            <div className={style.menu_link}>
              <Image src={'/img/mail.png'} width={40} height={40} alt='site'/>
              <Link href='/#'>xxx.ru</Link>
            </div>
            <div className={style.menu_link}>
              <Image src={'/img/vk.png'} width={40} height={40} alt='friends'/>
